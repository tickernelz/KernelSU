...
<span class="line"><span style="color:#A6ACCD;">                add_input_randomness(type, code, value);</span></span></code></pre></div><p>最後，再次建置您的核心，KernelSU 將會如期運作。</p>`,37),o=[e];function t(c,r,i,C,D,A){return n(),a("div",null,o)}const f=s(p,[["render",t]]);export{y as __pageData,f as default};
